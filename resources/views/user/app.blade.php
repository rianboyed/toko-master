...
<html lang="en">
  <head>
    <title>|AMUM|Hewan Aqiqah & Qurban </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="{{ route('home') }}" class="js-logo-clone">|AMUM-Aqiqah & Qurban|</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl. Cicukang No.54, Cisaranten Bina Harapan, Kec. Arcamanik Kota Bandung Jawa Barat Kode Pos: 40293</li>
                <li class="phone"><a href="tel://23923929210">+62 82117462475</a></li>
                <li class="email">174060027.mhs@mhs.ac.id</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script>| This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" class="text-primary">Colorlib</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
