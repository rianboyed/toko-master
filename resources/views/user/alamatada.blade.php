            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12 text-right">
                            <a href="{{ route('user.alamat.ubah',['id' => $alamat[0]->id] ) }}" class="btn btn-primary btn-sm left">Ubah Alamat</a>
                    </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                    <div class="col-md-12 text-right">
                            <a href="{{ url('/keranjang') }}" class="btn btn-warning btn-sm left">Lanjut Keranjang Pemesanan</a>
                    </div>
                    </div>
