                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td>Kurir</td>
                            <td>:</td>
                            <td  class="p-2">Petugas AMUM Kurir</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2"><img src="{{ url('/')}}/{{$order->bukti_pembayaran}}" alt="" srcset="" class="img-fluid" width="300"></td>
                        </tr>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-hovered" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td><img src="{{ url('/')}}/{{$dt->image}}" style="width: 200px;"></td>
